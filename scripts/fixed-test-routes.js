 ...
 * 
 * Usage: npm run test:fixed-routes
 */
...
async function testAllRoutes() {
  ...
  const browser = await puppeteer.launch({
    headless: "new", // Use "new" for newer versions of puppeteer
...
async function testRoute(page, route) {
  ...
  try {
    ...
    // Wait a bit to collect any console errors (using delay instead of waitForTimeout)
    await delay(2000);
