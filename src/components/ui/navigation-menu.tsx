...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ...
    className={cn(
      ...
      'absolute z-10 grid w-full p-4 md:w-48 lg:w-[300px]',
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Viewport
    ref={ref}
    className={cn(
      'relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full origin-[top_center] overflow-hidden rounded-md border bg-popover shadow-lg',
